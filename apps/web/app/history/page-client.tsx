...
const historyPageSkeletonIds = [
  "history-page-skeleton-1",
  "history-page-skeleton-2",
  "history-page-skeleton-3",
  "history-page-skeleton-4",
  "history-page-skeleton-5",
]

const historyListSkeletonIds = [
  "history-list-skeleton-1",
  "history-list-skeleton-2",
  "history-list-skeleton-3",
]
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 pt-2 sm:px-6 md:px-8 md:pt-0">
        {sessionsLoading ? (
          <div className="space-y-3">
            {historyListSkeletonIds.map((skeletonId) => (
